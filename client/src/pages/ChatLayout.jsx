      ...
      <Row>
        ...
        <ChatContainer md={7}>
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              <Button variant="link" className="p-0 me-2"><FaPhone /></Button>
              <Button variant="link" className="p-0 me-2"><FaVideo /></Button>
              <Button variant="link" className="p-0"><FaEllipsisV /></Button>
            </div>
          </div>
          <MessageContainer>
